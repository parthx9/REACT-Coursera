                    ...
                    <div className='col-12 col-md-9'>
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input name='telnum' type='tel' id='telnum' placeholder='Tel Number' value={this.state.telnum} onChange={this.handleInputChange} />                           
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                                <Label htmlFor='email' md={2}>E-Mail</Label>
                                <Col md={10}>
                                    <Input name='email' type='email' id='email' placeholder='E-Mail' value={this.state.email} onChange={this.handleInputChange} />                           
                                </Col>
                            </FormGroup>
                            <FormGroup row>
